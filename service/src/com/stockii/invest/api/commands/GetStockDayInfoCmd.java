...
@APICommand(name = "getStockDayInfo", description = "get stock dayinfo.", responseObject = StockBasicInfoResponse.class)
public class GetStockDayInfoCmd extends BaseListCmd {
	public static final Logger s_logger = Logger.getLogger(GetStockDayInfoCmd.class.getName());
	private static final String s_name = "getstockdayinforesponse";
	...
	public void execute() {
        ...
        List<StockBasicInfoVO> result = _stockService.searchForBasicDayStocks(this);
