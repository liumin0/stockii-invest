...
public class DeployVMCmd extends BaseAsyncCreateCmd {
    ...
    @Parameter(name=ApiConstants.DISPLAY_NAME, type=CommandType.STRING, required=true, description="an optional user generated name for the virtual machine")
    ...
    @Parameter(name="nicadapter", type=CommandType.STRING, description="the nicadapter for vmware vm.")
