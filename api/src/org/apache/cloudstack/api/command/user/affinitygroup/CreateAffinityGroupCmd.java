...
public class CreateAffinityGroupCmd extends BaseAsyncCreateCmd {
    ...
    @Parameter(name = ApiConstants.PROJECT_ID, type=CommandType.UUID, entityType=ProjectResponse.class, description = "an project for the affinity group. Must be used with domainId.")
    ...
    public String getAccountName() {
    	if(projectId != null){/*
    		Project project = _projectService.getProject(this.projectId);
    		Account pAccount = _accountService.getAccount(project.getProjectAccountId());
    		return pAccount.getAccountName();
    	*/}
        return accountName;
    }
    ...
    */}
    ...
    public void create() throws ResourceAllocationException {/*
        AffinityGroup result = _affinityGroupService.createAffinityGroup(this.getAccountName(), domainId, affinityGroupName,
