...
public class AttachVolumeCmd extends BaseAsyncCmd {
    ...
    @Parameter(name="isshared", type=CommandType.BOOLEAN, description="the virtual disk is shared. true,shared; false,not shared")
    ...
    public boolean isShared() {
    	return (isShared != null) ? isShared : false;
	}
