...
public class CreateZoneCmd extends BaseCmd {
    ...
    @Parameter(name = ApiConstants.ZONE_DETAILS, type = CommandType.MAP, description = "details for the zone")
    private Map<String, String> zoneDetails;
    ...
    public Map<String, String> getZoneDetails() {
        Map<String, String> zoneDetailsMap = null;
        if (zoneDetails != null && !zoneDetails.isEmpty()) {
        	zoneDetailsMap = new HashMap<String, String>();
            Collection<?> servicesCollection = zoneDetails.values();
            Iterator<?> iter = servicesCollection.iterator();
            while (iter.hasNext()) {
                HashMap<String, String> services = (HashMap<String, String>) iter.next();
                String key = services.get("key");
                String value = services.get("value");
                zoneDetailsMap.put(key, value);
            }
        }
