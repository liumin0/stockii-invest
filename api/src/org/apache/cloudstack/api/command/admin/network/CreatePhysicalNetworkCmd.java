...
public class CreatePhysicalNetworkCmd extends BaseAsyncCreateCmd {
    ...
    @Parameter(name = ApiConstants.PHYSICAL_NETWORK_DETAILS, type = CommandType.MAP, description = "details for the physical network")
    private Map<String, String> physicalnetworkdetails;
    /////////////////////////////////////////////////////
    /////////////////// Accessors ///////////////////////
    /////////////////////////////////////////////////////
    ...
    public Map<String, String> getPhysicalNetworkDetails() {
        Map<String, String> detailsMap = null;
        if (physicalnetworkdetails != null && !physicalnetworkdetails.isEmpty()) {
        	detailsMap = new HashMap<String, String>();
            Collection<?> servicesCollection = physicalnetworkdetails.values();
    ...
    */}
    ...
    public void create() throws ResourceAllocationException {/*
        PhysicalNetwork result = _networkService.createPhysicalNetwork(getZoneId(),getVlan(),getNetworkSpeed(), getIsolationMethods(),getBroadcastDomainRange(),getDomainId(), getTags(), getNetworkName(),getPhysicalNetworkDetails());
        if (result != null) {
