...
public class ListPhysicalNetworksCmd extends BaseListCmd {
    ...
    @Parameter(name=ApiConstants.FOR_VIRTUAL_NETWORK, type=CommandType.BOOLEAN, description="search by name")
    ...
    public void execute(){/*
        Pair<List<? extends PhysicalNetwork>, Integer> result = _networkService.searchPhysicalNetworks(getId(),getZoneId(),
                this.getKeyword(), this.getStartIndex(), this.getPageSizeVal(), getNetworkName(), forDeploy);
        if (result != null) {
