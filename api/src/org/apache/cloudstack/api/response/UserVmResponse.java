...
public class UserVmResponse extends BaseResponse implements ControlledEntityResponse {
    ...
    @SerializedName("memoryused") @Param(description="the amount of the vm's memory currently used")
    ...
    @SerializedName("nicadapter") @Param(description="The nicadapter for vmware vm.")
	...
	public void setNicAdapter(String nicAdapter) {
