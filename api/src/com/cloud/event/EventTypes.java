...
public class EventTypes {
    ...
    public static final String EVENT_NET_IP_RATE_UPDATE = "NET.IP.RATE.UPDATE";
    ...
    //backup
    public static final String EVENT_BACKUP_CREATE  = "BACKUP.CREATE";
    ...
    static {
        ...
        // backup
        entityEventDetails.put(EVENT_BACKUP_CREATE, GuestVlan.class.getName());
    }
