...
public class StorageSubsystemCommandHandlerBase implements StorageSubsystemCommandHandler {
    ...
    public Answer handleStorageCommands(StorageSubSystemCommand command) {
        ...
        } else if (command instanceof AttachShareCommand) {
            return execute((AttachShareCommand)command);
    ...
    protected Answer execute(CreateObjectCommand cmd) {
        ...
        s_logger.debug("qwertyuiop isThick:" + cmd.isThick());
        s_logger.debug("qwertyuiop isEagerZeroedThick:" + cmd.isEagerZeroedThick());
        try {
    ...
    protected Answer execute(AttachShareCommand cmd){
		return processor.attachShareVolume(cmd);
    }
