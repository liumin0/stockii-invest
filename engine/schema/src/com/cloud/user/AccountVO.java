...
public class AccountVO implements Account {
    @Id
    @TableGenerator(name="account_sq", table="sequence", pkColumnName="name", valueColumnName="value", pkColumnValue="account_seq", allocationSize=1)
    ...
    public AccountVO(long id, String accountName, long domainId, String networkDomain, short type, String uuid) {
    	this.id = id;
