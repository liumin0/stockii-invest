...
public class ServiceOfferingDaoImpl extends GenericDaoBase<ServiceOfferingVO, Long> implements ServiceOfferingDao {
    ...
    protected final SearchBuilder<ServiceOfferingVO> ServiceOfferingsByCpuRamName;
    ...
    public ServiceOfferingDaoImpl() {
        ...
        ServiceOfferingsByCpuRamName = createSearchBuilder();
        ServiceOfferingsByCpuRamName.and("cpu", ServiceOfferingsByCpuRamName.entity().getCpu(), SearchCriteria.Op.EQ);
        ServiceOfferingsByCpuRamName.and("ram", ServiceOfferingsByCpuRamName.entity().getRamSize(), SearchCriteria.Op.EQ);
        ServiceOfferingsByCpuRamName.and("name", ServiceOfferingsByCpuRamName.entity().getName(), SearchCriteria.Op.LIKE);
        ServiceOfferingsByCpuRamName.and("removed", ServiceOfferingsByCpuRamName.entity().getRemoved(), SearchCriteria.Op.NULL);
        ServiceOfferingsByCpuRamName.done();
    ...
    public ServiceOfferingVO findByCpuRamsizeName(long cpu, long ram, String name) {
        SearchCriteria<ServiceOfferingVO> sc = ServiceOfferingsByCpuRamName.create();
        sc.setParameters("name", name);
        sc.setParameters("cpu", cpu);
        sc.setParameters("ram", ram);
