...
public interface NetworkDao extends GenericDao<NetworkVO, Long> , StateDao<State, Network.Event, Network> {
    ...
    long countByZoneAndUri(long zoneId, String broadcastUri, String cidr);
    
    long countByZoneUriAndGuestType(long zoneId, String broadcastUri, String cidr, GuestType guestType);
