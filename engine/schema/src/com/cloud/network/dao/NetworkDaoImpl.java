...
public class NetworkDaoImpl extends GenericDaoBase<NetworkVO, Long> implements NetworkDao {
    ...
    protected void init() {
        ...
        //WSH20130917["account"--->"account_id"]
        ...
        CountByZoneAndURI.and("cidr", CountByZoneAndURI.entity().getCidr(), Op.EQ);
    ...
    @Override
    public long countByZoneAndUri(long zoneId, String broadcastUri, String cidr) {
    ...
    @Override
    public long countByZoneUriAndGuestType(long zoneId, String broadcastUri, String cidr, GuestType guestType) {
        SearchCriteria<Long> sc = CountByZoneAndURI.create();
        sc.setParameters("dataCenterId", zoneId);
        sc.setParameters("broadcastUri", broadcastUri);
    ...
    public List<NetworkVO> listByOwner(long ownerId) {
        SearchCriteria<NetworkVO> sc = AllFieldsSearch.create();
        //WSH20130917["account"--->"account_id"]
        sc.setParameters("account_id", ownerId);
        return listBy(sc);
    }
