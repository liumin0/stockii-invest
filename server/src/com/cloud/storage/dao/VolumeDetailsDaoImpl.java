...
public class VolumeDetailsDaoImpl extends GenericDaoBase<VolumeDetailVO, Long> implements VolumeDetailsDao {
    ...
    protected final SearchBuilder<VolumeDetailVO> ShareVolumeDetailSearch;
    protected final SearchBuilder<VolumeDetailVO> DetailSearchByValue;
    ...
    public VolumeDetailsDaoImpl() {
        ...
        ShareVolumeDetailSearch = createSearchBuilder();
        ShareVolumeDetailSearch.and("volumeId", ShareVolumeDetailSearch.entity().getVolumeId(), SearchCriteria.Op.EQ);
        ShareVolumeDetailSearch.and("name", ShareVolumeDetailSearch.entity().getName(), SearchCriteria.Op.LIKE);
        ShareVolumeDetailSearch.done();
        
        DetailSearchByValue = createSearchBuilder();
        DetailSearchByValue.and("value", DetailSearchByValue.entity().getValue(), SearchCriteria.Op.EQ);
        DetailSearchByValue.done();
    }
...
//        expunge(sc);
    ...
    @Override
    public List<VolumeDetailVO> findShareDetailByLike(long volumeId) {
    	String name = "instance-";
        SearchCriteria<VolumeDetailVO> sc = ShareVolumeDetailSearch.create();
        sc.setParameters("volumeId", volumeId);
        sc.setParameters("name", name + "%");
    ...
    @Override
    public List<VolumeDetailVO> findDetailByVmId(String vmId) {
        SearchCriteria<VolumeDetailVO> sc = DetailSearchByValue.create();
        sc.setParameters("value", vmId);

        return search(sc, null);
    }

	@Override
	public Boolean isSharedDisk(long volumeId) {
        VolumeDetailVO detail = findDetail(volumeId, "isshared");
        
        if(detail == null){
        	return null;
        } else if(detail.getValue().equals("enabled")){
        	return true;
        }else{
        	return false;
        }
