...
//	UpgradeURL("Advanced", ManagementServer.class, String.class, "upgrade.url", "http://example.com:8080/client/agent/update.zip", "The upgrade URL is the URL of the management server that agents will connect to in order to automatically upgrade.", null),
    ...
    CleanCostDay("Advanced", ManagementServer.class, Integer.class, "report.virtual.cost.clean_day", "31", "The interval (in days) between cleanup for removed virtual_billing_summary_day", null),
    CleanCostHour("Advanced", ManagementServer.class, Integer.class, "report.virtual.cost.clean_hour", "168", "The interval (in hours) between cleanup for removed virtual_billing_summary_hour", null),
    CleanCostMonth("Advanced", ManagementServer.class, Integer.class, "report.virtual.cost.clean_month", "6", "The interval (in months) between cleanup for removed virtual_billing_summary_month", null),
    CleanCostOriginalDay("Advanced", ManagementServer.class, Integer.class, "report.virtual.cost.clean_original_day", "31", "The interval (in hours) between cleanup for removed virtual_billing_summary", null),
    CleanCostYear("Advanced", ManagementServer.class, Integer.class, "report.virtual.cost.clean_year", null, "The interval (in years) between cleanup for removed virtual_billing_summary_year", null),            
    ...
    VmwareReserveCpu("Advanced", ManagementServer.class, Boolean.class, "vmware.reserve.cpu", "false", "Specify whether or not to reserve CPU based on CPU overprovisioning factor", null, ConfigurationParameterScope.cluster.toString()),
    VmwareReserveMem("Advanced", ManagementServer.class, Boolean.class, "vmware.reserve.mem", "false", "Specify whether or not to reserve memory based on memory overprovisioning factor", null, ConfigurationParameterScope.cluster.toString()),
    ...
    VmwareVCConnectionsMaxNum("Advanced", ManagementServer.class, Integer.class, "vmware.vc.connections.MaxNum", "128", "The max number of VC connections", null),
    ...
    // report server
    ReportServer("Advanced", ManagementServer.class, String.class, "report.server.ip", "serverip:port/jor/reportviewer?file=/reportXml/", "report server URL", null),
	...
	//RSA-VMpasswordRest
	RSAPublicKey("RSAKey", ManagementServer.class, String.class, "rsa.public.key", "AAAAgQDtInqJWT8dfFus02VnMxjN9DB136xxMQOEVnnuI0c+ixWqplAiXeHhne0rI0oowgo+dkLeVeiM22rEmiiCmGvvAvFnIrjIdQonz6gBj4a6KB3pqpjnCqNIB5gr2duglK7OrWUyZuGuO6jvnQ12VDX/VAQp1wuJ/k2NaBvGra35zQAAAAMBAAE=", "The public key for RSA encrypt", null),
	RSAPrivateKey("RSAKey", ManagementServer.class, String.class, "rsa.private.key", "", "The private key for RSA decrypt", null),
	
	//resource-tag
	HostPodTag("Advanced", ManagementServer.class, String.class, "resource.tag.hostpod", "resourceZone", "the key of resource tag for hostpod", null),
	ClusterTag("Advanced", ManagementServer.class, String.class, "resource.tag.cluster", "clusterType,strategy", "the key of resource tag for cluster", null),
	
	VirtualDiskThick("Advanced", ManagementServer.class, Boolean.class, "virtualdisk.type.thick", "false", "If set to true, the disk type is thick.If set to false, the disk type is thin.", null, ConfigurationParameterScope.zone.toString()),
	VirtualDiskEagerzeroed("Advanced", ManagementServer.class, Boolean.class, "thick.eagerzeroed", "false", "If set to true, the disk type is eagerZeroedThick.If set to false, the disk type is preallocated.", null, ConfigurationParameterScope.zone.toString());
    ...
    static {
    	...
    	_configs.put("RSAKey", new ArrayList<Config>());
