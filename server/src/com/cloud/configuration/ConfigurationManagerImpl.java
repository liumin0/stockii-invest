...
public class ConfigurationManagerImpl extends ManagerBase implements ConfigurationManager, ConfigurationService {
    ...
    public boolean deletePod(DeletePodCmd cmd) {
       ...
       //delete all pod resource tag
        List<? extends ResourceTag> resourceTag = resourceTagDao.listBy(podId, TaggedResourceType.HostPod);
        for(ResourceTag tag : resourceTag){
        	boolean flag = resourceTagDao.removeByIdAndType(tag.getResourceId(), TaggedResourceType.HostPod);
        }
    ...
    public DataCenterVO createZone(long userId, String zoneName, String dns1, String dns2, String internalDns1,
            ...
            boolean isLocalStorageEnabled, String ip6Dns1, String ip6Dns2, Map<String, String> zoneDetails) {
        ...
        try {
            ...
            if (zoneDetails != null && !zoneDetails.isEmpty()) {
            	_dcDetailsDao.persist(zone.getId(), zoneDetails);
            }
    ...
    public DataCenter createZone(CreateZoneCmd cmd) {
        ...
        Map<String, String> zoneDetails = cmd.getZoneDetails();
        ...
        return createZone(userId, zoneName, dns1, dns2, internalDns1, internalDns2, guestCidr,
                domainVO != null ? domainVO.getName() : null, domainId, zoneType, allocationState, networkDomain,
                        isSecurityGroupEnabled, isLocalStorageEnabled, ip6Dns1, ip6Dns2, zoneDetails);
    }
