...
public class ApiServer extends ManagerBase implements HttpRequestHandler, ApiServerService {
    ...
    public void init() {
        Integer apiPort = 8096; // api port, null by default
...
/*            if (account.getType() == Account.ACCOUNT_TYPE_ADMIN) {
    ...
    public boolean verifyRequest(Map<String, Object[]> requestParameters, Long userId) throws ServerApiException {
        try {/*
            ...
            if (commandName.equals("listLoginDomains"))	return true;
            ...
            if (!equalSig) {
                s_logger.info("User signature: " + signature + " is not equaled to computed signature: " + computedSignature + "; unsignedRequest: " + unsignedRequest);
            }
            return equalSig;
        */} catch (ServerApiException ex){
            throw ex;
