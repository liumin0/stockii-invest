...
//            }
    ...
    protected void finalizeNetworkRulesForNetwork(Commands cmds, DomainRouterVO router, Provider provider, Long guestNetworkId) {
        ...
        if (publicIps != null && !publicIps.isEmpty()) {
            ...
            if (!firewallRulesIngress.isEmpty()) {
            	//load CIDRS from FirewallRulesCidrsDao
            	for(FirewallRule ruleIngress : firewallRulesIngress) {
            		_rulesDao.loadSourceCidrs((FirewallRuleVO) ruleIngress);
            	}
    ...
    protected void createAssociateIPCommands(final VirtualRouter router, final List<? extends PublicIpAddress> ips, Commands cmds, long vmId) {
